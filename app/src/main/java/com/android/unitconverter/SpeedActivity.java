...
public class SpeedActivity extends AppCompatActivity  implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerArray.add("miles per hour");
        spinnerArray.add("foot per second");
        spinnerArray.add("metre per second");
        spinnerArray.add("kilometre per hour");
        spinnerArray.add("knot");
...
//        mDouble2 = Double.parseDouble(editTextB.getText().toString());
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (a.equals("kilometre per hour")){
            switch (b) {
                case "miles per hour":
